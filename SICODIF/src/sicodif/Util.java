...
public class Util {
 ...
 "<div id='msginfo'>" + Mensaje + "</div><script type='text/javascript'>$(document).ready(function(){$('#msginfo').fadeIn(1000);setTimeout('hide()',450000);});function hide(){$('#msginfo').fadeOut(3000);}</script>";
    ...
    public static String ResultadosControlDiferidoEnm(FisResultadosForm bean, String usuario) {
        ...
        try {
            con = dc.abrirConexion();
            call = con.prepareCall("{ ? = call pkg_sicodif.resultados_control_enm (?,?,?,?,?, ?,?,?,?,?, ?,? ,?) }");
            call.registerOutParameter(1, OracleTypes.VARCHAR);
            call.setString(2, bean.getKey_year());
            call.setString(3, bean.getKey_cuo());
            call.setString(4, bean.getReg_serial());
    ...
    public static String FinalizaControlDiferido(FisFinalizaForm bean, String usuario) {
        ...
        try {
            con = dc.abrirConexion();
            call = con.prepareCall("{ ? = call pkg_sicodif.finaliza_control (?,?,?, ?,?,?,?,?, ?,?,?  ,?,?,?,?, ?,?,?,?) }");
            call.registerOutParameter(1, OracleTypes.VARCHAR);
            call.setString(2, bean.getKey_year());
            call.setString(3, bean.getKey_cuo());
            call.setString(4, bean.getReg_serial());
    ...
    public static String FinalizaControlDiferidoEnm(FisFinalizaForm bean, String usuario) {
        ...
        try {
            con = dc.abrirConexion();
            call = con.prepareCall("{ ? = call pkg_sicodif.finaliza_control_enm (?,?,?, ?,?,?,?,?, ?,?,?  ,?,?,?,?, ?,?,?,?) }");
            call.registerOutParameter(1, OracleTypes.VARCHAR);
            call.setString(2, bean.getKey_year());
            call.setString(3, bean.getKey_cuo());
            call.setString(4, bean.getReg_serial());
    ...
    public static String TablaReporte1(String gerencia, String fec_ini, String fec_fin) {
        ...
        try {          
            ...
            {     
                    ...
                    tb=tb+" <tr><td ><div align='left'><table> <tr><td align='left'><strong>Gerencia:</strong> </td><td align='left'>"+vgerencia +"</td></tr><tr><td align='left'><strong>Fecha registro desde:</strong></td><td>"+fec_ini+"</td></tr><tr><td align='left'><strong>Fecha registro hasta:</strong></td><td>"+fec_fin+"</td></tr></table></div></td></tr>";
                    tb =tb+ "</table>";
                    ...
                    while(rss != null && rss.next())
                    {
                        if(rss.getString(1).equals("TOTAL"))
                           tb=tb+"<tr><th>"+rss.getString(1)+"</th><th>"+rss.getString(2)+"</th><th>"+rss.getString(4)+"</th><th>"+rss.getString(3)+"</th><th>"+rss.getString(5)+"</th><th>"+rss.getString(8)+"</th><th>"+rss.getString(6)+"</th><th>"+rss.getString(7)+"</th></tr>";
                        else
                           tb=tb+"<tr><td>"+rss.getString(1)+"</td><td>"+rss.getString(2)+"</td><td>"+rss.getString(4)+"</td><td>"+rss.getString(3)+"</td><td>"+rss.getString(5)+"</td><td>"+rss.getString(8)+"</td><td>"+rss.getString(6)+"</td><td>"+rss.getString(7)+"</td></tr>";
                    }
    ...
    public static String TablaReporte4(String gerencia, String fec_ini, String fec_fin) {
        ...
        try {
            ...
            {     
                    ...
                    {
                        if(rss.getString(1).equals("TOTAL"))
                           tb=tb+"<tr><th>"+rss.getString(9)+"</th><th>"+rss.getString(1)+"</th><th>"+rss.getString(2)+"</th><th>"+rss.getString(4)+"</th><th>"+rss.getString(3)+"</th><th>"+rss.getString(5)+"</th><th>"+rss.getString(8)+"</th><th>"+rss.getString(6)+"</th><th>"+rss.getString(7)+"</th><th>"+rss.getString(10)+"</th></tr>";
                        else
                           tb=tb+"<tr><td>"+rss.getString(9)+"</td><td>"+rss.getString(1)+"</td><td>"+rss.getString(2)+"</td><td>"+rss.getString(4)+"</td><td>"+rss.getString(3)+"</td><td>"+rss.getString(5)+"</td><td>"+rss.getString(8)+"</td><td>"+rss.getString(6)+"</td><td>"+rss.getString(7)+"</td><td>"+rss.getString(10)+"</td></tr>";
                    }
    ...
    public static String TablaReporte5(String gerencia, String fec_ini, String fec_fin) {
        ...
        try {
            ...
            {     
                    ...
                    tb=tb+" <tr><td ><div align='left'><table> <tr><td align='left'><strong>Gerencia:</strong> </td><td align='left'>"+vgerencia +"</td></tr><tr><td align='left'><strong>Fecha conclusi&oacute;n desde:</strong></td><td>"+fec_ini+"</td></tr><tr><td align='left'><strong>Fecha conclusi&oacute;n hasta:</strong></td><td>"+fec_fin+"</td></tr></table></div></td></tr>";
                    tb =tb+ "</table>";
                    ...
                    {
                        if(rss.getString(1).equals("TOTAL")){
                            tb=tb+"<tr><th>"+rss.getString(1)+"</th><th>"+sumCdifconclui+"</th><th>"+sumCdifconclconObs+"</th><th style='text-align:right'>"+df.format(Double.valueOf(rss.getString(4)).doubleValue())+"</th><th style='text-align:right'>"+d.format(Double.valueOf(rss.getString(5)).doubleValue())+"</th><th style='text-align:right'>"+d.format(Double.valueOf(rss.getString(6)).doubleValue())+"</th><th style='text-align:right'>"+d.format(Double.valueOf(rss.getString(11)).doubleValue())+"</th><th style='text-align:right'>"+d.format(Double.valueOf(rss.getString(13)).doubleValue())+"</td><th style='text-align:right'>"+d.format(Double.valueOf(rss.getString(7)).doubleValue())+"</th><th style='text-align:right'>"+d.format(Double.valueOf(rss.getString(8)).doubleValue())+"</th><th  style='text-align:right'>"+d.format(Double.valueOf(rss.getString(9)).doubleValue())+"</th><th style='text-align:right'>"+d.format(Double.valueOf(rss.getString(10)).doubleValue())+"</th><th style='text-align:right'>"+d.format(Double.valueOf(rss.getString(14)).doubleValue())+"</th><th style='text-align:right'>"+d.format(Double.valueOf(rss.getString(12)).doubleValue())+"</th></tr>";
                        } else{
                        ...
                        tb=tb+"<tr><td>"+rss.getString(1)+"</td><td>"+rss.getString(2)+"</td><td>"+rss.getString(3)+"</td><td style='text-align:right'>"+df.format(Double.valueOf(rss.getString(4)).doubleValue())+"</td><td  style='text-align:right'>"+d.format(Double.valueOf(rss.getString(5)).doubleValue())+"</td><td style='text-align:right'>"+d.format(Double.valueOf(rss.getString(6)).doubleValue())+" </td><td style='text-align:right'>"+d.format(Double.valueOf(rss.getString(11)).doubleValue())+" </td><td style='text-align:right'>"+d.format(Double.valueOf(rss.getString(13)).doubleValue())+"</td><td style='text-align:right'>"+d.format(Double.valueOf(rss.getString(7)).doubleValue())+"</td><td style='text-align:right'>"+d.format(Double.valueOf(rss.getString(8)).doubleValue())+"</td><td style='text-align:right'>"+d.format(Double.valueOf(rss.getString(9)).doubleValue())+"</td><td style='text-align:right'>"+d.format(Double.valueOf(rss.getString(10)).doubleValue())+"</td><td style='text-align:right'>"+d.format(Double.valueOf(rss.getString(14)).doubleValue())+"</td><td style='text-align:right'>"+d.format(Double.valueOf(rss.getString(12)).doubleValue())+"</td></tr>";
                        }
                    }
    ...
    public static String BandejaSupervisor(String gerencia, String estado) {
        ...
        try {
            ...
            {     
                    ...
                    tb=tb+"<th>No.</th><th width='15%'>Declaraci&oacute;n</th><th>Patr&oacute;n</th><th>&Iacute;tems</th><th>Importador  </th><th>NIT Importador</th><th>Fecha Levante</th><th>Codigo CD</th><th>Fiscalizador</th><th>Fecha Registro</th><th>&nbsp;</th></tr>";
                    String ia;
                    int c=1;
                    ...
                    while(rss != null && rss.next())
                    {
                        ...
                        tb = tb + "<tr><td>"+c+"</td><td>";
                        tb = tb + "<a onclick=window.open('"+rss.getString(14)+"/repduiform.jsp?gestion="+rss.getString(1)+"&aduana="+rss.getString(2)+"&registro="+rss.getString(3)+"&vdec=&vop=&vusu=&bandera=undefined','_blank','width=550,height=580,menubar=0,scrollbars=yes,toolbar=0,location=0,directories=0,resizable=0,top=0,left=0') href='javascript:void(0)' >";
                        tb = tb + rss.getString(1)+"/"+rss.getString(2)+"/C-"+rss.getString(3)+"</a></td>";
                        tb = tb + "<td>"+rss.getString(4)+"</td><td>"+rss.getString(5)+"</td><td>"+rss.getString(7)+"</td><td>"+rss.getString(6)+"</td><td>"+rss.getString(8)+"</td><td>"+rss.getString(9)+"</td><td>"+rss.getString(10)+"</td><td>"+rss.getString(11)+"</td><td><a href='"+ia +"' style='color:#0f69b4; font-weight:900;'>Procesar</a></td></tr>";
                        c=c+1;      
                    }
    ...
    public static String BandejaFiscalizador(String fiscalizador, String estado) {
        ...
        try {
            ...
            {     
                    ...
                    tb = "<table id='backgroun3'>";
                    tb=tb+"<caption>LISTADO DE DECLARACIONES OBSERVADAS CON FICHA INFORMATIVA</caption>";
                    tb=tb+"<th>No.</th><th width='15%'>Declaraci&oacute;n</th><th>Patr&oacute;n</th><th>&Iacute;tems</th><th>Importador  </th><th>NIT Importador</th><th>Fecha Levante</th><th>Codigo CD</th><th>Estado</th><th>Fecha Asignaci&oacute;n</th><th>&nbsp;</th></tr>";
                    String ia;
                    int c=1;
                    while(rss != null && rss.next())
                    {
                        ...
                        tb=tb+"<tr><td>1</td><td>"+rss.getString(1)+"/"+rss.getString(2)+"/C-"+rss.getString(3)+"</td><td>"+rss.getString(4)+"</td><td>"+rss.getString(5)+"</td><td>"+rss.getString(7)+"</td><td>"+rss.getString(6)+"</td><td>"+rss.getString(8)+"</td><td>"+rss.getString(9)+"</td><td>"+rss.getString(10)+"</td><td>"+rss.getString(11)+"</td><td><a href='"+ia +"' style='color:#0f69b4; font-weight:900;'>Orden de Fiscalizaci&oacute;n</a></td></tr>";
                        c=c+1;    
    ...
    public static String TablaReporte2(String gerencia, String fec_ini, String fec_fin) {
        ...
        try {
            ...
            {     
                    ...
                    tb=tb+"<tr><th>&nbsp;</th><th>A</th><th>B</th><th>C</th><th>D=B+C</th><th>E</th><th>F</th><th>G=D+E+F</th></tr>";
                    
                    tb=tb+"<tr><th>GERENCIA REGIONAL</th><th>TOTAL CD CONCLUIDOS PAGADOS</th><th>TOTAL TRIBUTOS OMITIDO ACTUALIZADO - INTERES EN BS</th><th>TOTAL CONTRAVENCION ADUANERA EN BS</th><th>TOTAL DEUDA TRIBUTARIA</th><th>TOTAL SANCION POR OMISION DE PAGO EN BS</th><th>TOTAL CONTRABANDO EN BS</th><th>TOTAL RECUPERADO EN BS</th></tr>";
                    while(rss != null && rss.next())
                    {
                        if(rss.getString(1).equals("TOTAL"))
                            tb=tb+"<tr><th>"+rss.getString(1)+"</th><th>"+df.format(Double.valueOf(rss.getString(2)).doubleValue())+"</th><th style='text-align:right'>"+d.format(Double.valueOf(rss.getString(3)).doubleValue())+"</th><th style='text-align:right'>"+d.format(Double.valueOf(rss.getString(4)).doubleValue())+"</th><th style='text-align:right'>"+d.format(Double.valueOf(rss.getString(5)).doubleValue())+"</th><th style='text-align:right'>"+d.format(Double.valueOf(rss.getString(6)).doubleValue())+"</th><th style='text-align:right'>"+d.format(Double.valueOf(rss.getString(7)).doubleValue())+"</th><th style='text-align:right'>"+d.format(Double.valueOf(rss.getString(8)).doubleValue())+"</th></tr>";
                            else
                        tb=tb+"<tr><td>"+rss.getString(1)+"</td><td>"+df.format(Double.valueOf(rss.getString(2)).doubleValue())+"</td><td style='text-align:right'>"+d.format(Double.valueOf(rss.getString(3)).doubleValue())+"</td><td style='text-align:right'>"+d.format(Double.valueOf(rss.getString(4)).doubleValue())+"</td><td style='text-align:right'>"+d.format(Double.valueOf(rss.getString(5)).doubleValue())+"</td><td style='text-align:right'>"+d.format(Double.valueOf(rss.getString(6)).doubleValue())+"</td><td style='text-align:right'>"+d.format(Double.valueOf(rss.getString(7)).doubleValue())+"</td><td style='text-align:right'>"+d.format(Double.valueOf(rss.getString(8)).doubleValue())+"</td></tr>";
                    }
    ...
    public static String TablaReporte3(String gerencia, String fec_ini, String fec_fin) {
        ...
        try {
            ...
            {     
                    ...
                    tb=tb+"<tr><th>GERENCIA REGIONAL</th><th>TOTAL CD CONCLUIDOS NO PAGADOS</th><th>TOTAL TRIBUTOS OMITIDO</th><th>TOTAL CONTRAVENCION ADUANERA EN UFV's</th><th>TOTAL SANCION POR OMISION DE PAGO EN BS</th><th>TOTAL CONTRABANDO EN BS</th></tr>";
                    while(rss != null && rss.next())
                    {
                        if(rss.getString(1).equals("TOTAL"))
                            tb=tb+"<tr><th>"+rss.getString(1)+"</th><th>"+df.format(Double.valueOf(rss.getString(2)).doubleValue())+"</th><th style='text-align:right'>"+d.format(Double.valueOf(rss.getString(3)).doubleValue())+"</th><th style='text-align:right'>"+d.format(Double.valueOf(rss.getString(4)).doubleValue())+"</th><th style='text-align:right'>"+d.format(Double.valueOf(rss.getString(5)).doubleValue())+"</th><th style='text-align:right'>"+d.format(Double.valueOf(rss.getString(6)).doubleValue())+"</th></tr>";
    ...
    public static String TablaDeclaracion(FisDeclaracionForm bean) {
        ...
        if(!(bean.getMensaje().equals("SIN CODIGO")))
        {
            if( bean.getCd_numero().equals("0")){            
                ...
                rs = rs + "<tr><th>N&uacute;mero Control Diferido:</th><td><strong>"+bean.getMensaje()+"</strong></td></tr>";
            }
            rs = rs + "<tr><th>Fiscalizador:</th><td><strong>"+bean.getFiscalizador()+"</strong></td></tr>";
            
        }
        
        rs = rs + "<tr><th>Declaraci&oacute;n:</th><td><a onclick=window.open('"+bean.getPagina()+"/repduiform.jsp?gestion="+bean.getKey_year()+"&aduana="+bean.getKey_cuo()+"&registro="+bean.getReg_serial()+"&vdec=&vop=&vusu=&bandera=undefined','_blank','width=550,height=580,menubar=0,scrollbars=yes,toolbar=0,location=0,directories=0,resizable=0,top=0,left=0') href='javascript:void(0)' >" +bean.getKey_year()+"/"+bean.getKey_cuo()+"/C-"+bean.getReg_serial()+" </a></td></tr>";
        
        rs = rs + "<tr><th>Documentos:</th><td><table><tr>";
        rs = rs + "<td><a onclick=window.open('"+bean.getPagina()+"/repduiform.jsp?gestion="+bean.getKey_year()+"&aduana="+bean.getKey_cuo()+"&registro="+bean.getReg_serial()+"&vdec=&vop=&vusu=&bandera=undefined','_blank','width=550,height=580,menubar=0,scrollbars=yes,toolbar=0,location=0,directories=0,resizable=0,top=0,left=0') href='javascript:void(0)' >DUI</a></td>";
        rs = rs + "<td><a onclick=window.open('"+bean.getPagina()+"/DUI_docadi.jsp?gestion="+bean.getKey_year()+"&aduana="+bean.getKey_cuo()+"&registro="+bean.getReg_serial()+"&vdec=&vop=&vusu=&bandera=undefined','_blank','width=550,height=580,menubar=0,scrollbars=yes,toolbar=0,location=0,directories=0,resizable=0,top=0,left=0') href='javascript:void(0)' >Doc. Adicionales</a></td>";
        rs = rs + "<td><a onclick=window.open('"+bean.getPagina()+"/DUI_notaval.jsp?gestion="+bean.getKey_year()+"&aduana="+bean.getKey_cuo()+"&registro="+bean.getReg_serial()+"&vdec=&vop=&vusu=&bandera=undefined','_blank','width=550,height=580,menubar=0,scrollbars=yes,toolbar=0,location=0,directories=0,resizable=0,top=0,left=0') href='javascript:void(0)' >Nota de Valor</a></td>";
        rs = rs + "<td><a onclick=window.open('"+bean.getPagina()+"/DUI_infadi.jsp?gestion="+bean.getKey_year()+"&aduana="+bean.getKey_cuo()+"&registro="+bean.getReg_serial()+"&vdec=&vop=&vusu=&bandera=undefined','_blank','width=550,height=580,menubar=0,scrollbars=yes,toolbar=0,location=0,directories=0,resizable=0,top=0,left=0') href='javascript:void(0)' >Inf. Adicional</a></td>";
        rs = rs + "<td><a onclick=window.open('"+bean.getPagina()+"/DUI_frv.jsp?gestion="+bean.getKey_year()+"&aduana="+bean.getKey_cuo()+"&registro="+bean.getReg_serial()+"&vdec=&vop=&vusu=&bandera=undefined','_blank','width=550,height=580,menubar=0,scrollbars=yes,toolbar=0,location=0,directories=0,resizable=0,top=0,left=0') href='javascript:void(0)' >FRV</a></td>";
        ...
        rs = rs + "<table id='backgroun2'><tr><th>Operaci&oacute;n</th><th>Fecha</th><th>Descripci&oacute;n</th><th>Usuario</th></tr>";
        rs = rs + "<tr><td>Registro</td><td>"+bean.getFecha_registro_control()+"</td><td>REGISTRO DE CONTROL DIFERIDO</td><td>"+bean.getUsuario_registro()+"</td></tr>";
        
        if(bean.getEstado().equals("RECHAZADO")){
        rs = rs + "<tr><td>Rechazado</td><td>"+bean.getFechalog()+"</td><td>RECHAZO DE CONTROL DIFERIDO</td><td>"+bean.getUsuariolog()+"</td></tr>";
        }
        
        if(bean.getFecha_notificacion() != null)
        rs = rs + "<tr><td>Notificaci&oacute;n</td><td>"+bean.getFecha_notificacion()+"</td><td>"+bean.getObs_notificacion()+"</td><td>"+bean.getUsuario_notificacion()+"</td></tr>";
        
        if(bean.getFec_liquidacion() != null)
        rs = rs + "<tr><td>Resultados</td><td>"+bean.getFec_liquidacion()+"</td><td>MONTO TOTAL (Bs): "+bean.getMonto_total()+"</td><td>"+bean.getUsuario_resultados()+"</td></tr>";
        
        if(bean.getFecha_aceptacion() != null)
        rs = rs + "<tr><td>Aceptaci&oacute;n Enmienda</td><td>"+bean.getFecha_aceptacion()+"</td><td>ACEPTACION DE ENMIENDA</td><td>"+bean.getUsuario_aceptacion()+"</td></tr>";
        
        if(bean.getFecha_finalizacion() != null)
        rs = rs + "<tr><td>Finalizaci&oacute;n</td><td>"+bean.getFecha_finalizacion()+"</td><td>"+bean.getObs_finalizacion()+"</td><td>"+bean.getUsuario_finalizacion()+"</td></tr>";
      
       
        
        if(bean.getFec_not_doc() != null)
        rs = rs + "<tr><td>Notificaci&oacute;n Documento de Conclusi&oacute;n</td><td>"+bean.getFec_not_doc()+"</td><td>TIPO NOTIFICACION: "+bean.getTip_not_doc()+"</td><td>"+bean.getUsuario_not_doc_con()+"</td></tr>";
        
       
    
        if(bean.getFec_env_legal() != null)
        rs = rs + "<tr><td>Envio a Unidad Legal</td><td>"+bean.getFec_env_legal()+"</td><td>NRO. DE NOTA: "+bean.getNro_env_legal()+"</td><td>"+bean.getUsuario_env_legal()+"</td></tr>";
        rs = rs + "</table>";
        ...
        try {
            ...
            if(rs.equals("CORRECTO"))
            {
                    ...
                    while(rss != null && rss.next())
                    {
                        ...
                        {
                            rs=rs+"<option selected value='"+rss.getString(1)+"'>"+rss.getString(2)+"</option>";
    ...
    public static String DevuelveFiscalizadores(String gerencia) {
        ...
        try {
            ...
            if(rs.equals("CORRECTO"))
            {
                    ...
                    if(sw2.equals("0"))
                        rs=rs+" <option selected value=''>-- No se Registraron Fiscalizadores en esta Regional --</option>";
...
//reporte de Resultados de deudas -- dibuja la tabla del reporte del detalle de recaudaciones
        ...
        try {
            ...
            {     
                    ...
                    tb =tb+ "</table>";
                    tb =tb+ "<table id='backgroun3'>";                    
                    tb=tb+"<tr><th colspan='4'>DATOS DE LA DECLARACI&Oacute;N</th><th colspan='5'>MONTO DETERMINADO</th><th colspan='5'>MONTO COBRADO A LA FECHA</th></tr>";
                    ...
                    while(rss != null && rss.next())
                    {
                        ...
                        tb=tb+"<tr><td>"+rss.getString(2)+"</td><td>"+rss.getString(5)+"</td><td>"+rss.getString(6)+"</td><td>"+rss.getString(7)+"</td><td style='text-align:right'>"+df.format(Double.valueOf(rss.getString(30)).doubleValue())+"</td><td style='text-align:right'>"+df.format(Double.valueOf(rss.getString(31)).doubleValue())+"</td><td style='text-align:right'>"+df.format(Double.valueOf(rss.getString(32)).doubleValue())+"</td><td style='text-align:right'>"+df.format(Double.valueOf(rss.getString(33)).doubleValue())+"</td><td style='text-align:right'>"+df.format(Double.valueOf(rss.getString(34)).doubleValue())+"</td><td style='text-align:right'>"+df.format(Double.valueOf(rss.getString(64)).doubleValue())+"</td><td style='text-align:right'>"+df.format(Double.valueOf(rss.getString(65)).doubleValue())+"</td><td style='text-align:right'>"+df.format(Double.valueOf(rss.getString(66)).doubleValue())+"</td><td style='text-align:right'>"+df.format(Double.valueOf(rss.getString(67)).doubleValue())+"</td><td style='text-align:right'>"+df.format(Double.valueOf(rss.getString(68)).doubleValue())+"</td></tr>";
