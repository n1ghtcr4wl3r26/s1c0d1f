...
public class FisRrecaudacionesAction extends Action {
    /**
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        FisRrecaudacionesForm bean = (FisRrecaudacionesForm)request.getAttribute("FisRrecaudacionesForm");
        ...
        if(bean.getReporte().equals("regional"))
            ...
            if (usuario != null) {
                //reporte nacional
                    ...
                    {
                            bean.setDeclaracion(Util.TablaReporte5(bean.getGerencia(), bean.getFec_desde(), bean.getFec_hasta()));  
                ...
                {
                        bean.setDeclaracion(Util.TablaReporte5(gerencia, bean.getFec_desde(), bean.getFec_hasta()));  
                    bean.setEstado("CORRECTO");
                        link = "volver2";
                }
                else 
