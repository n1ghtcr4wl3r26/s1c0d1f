...
public class FisRpagadosAction extends Action {
    /**
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        FisRpagadosForm bean = (FisRpagadosForm)request.getAttribute("FisRpagadosForm");
        ...
        if(bean.getReporte().equals("regional"))
            ...
            if (usuario != null) {
                    ...
                    {
                            bean.setDeclaracion(Util.TablaReporte2(bean.getGerencia(), bean.getFec_desde(), bean.getFec_hasta()));  
                ...
                {
                        bean.setDeclaracion(Util.TablaReporte2(gerencia, bean.getFec_desde(), bean.getFec_hasta()));  
                    bean.setEstado("CORRECTO");
                        link = "volver2";
                }
                else 
