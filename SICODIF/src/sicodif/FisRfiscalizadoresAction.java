...
public class FisRfiscalizadoresAction extends Action {
    /**
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        if (usuario != null) {
                ...
                {
                        bean.setDeclaracion(Util.TablaReporte4(bean.getGerencia(), bean.getFec_desde(), bean.getFec_hasta()));  
            ...
            {
                    bean.setDeclaracion(Util.TablaReporte4(gerencia, bean.getFec_desde(), bean.getFec_hasta()));  
                    bean.setEstado("CORRECTO");
                    link = "volver2";
            }
            else 
