...
public class FisRnopagadosAction extends Action {
    /**
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        FisRnopagadosForm bean = (FisRnopagadosForm)request.getAttribute("FisRnopagadosForm");
        ...
        if(bean.getReporte().equals("regional"))
            ...
            if (usuario != null) {
                    ...
                    {
                            bean.setDeclaracion(Util.TablaReporte3(bean.getGerencia(), bean.getFec_desde(), bean.getFec_hasta()));  
                ...
                {
                        bean.setDeclaracion(Util.TablaReporte3(gerencia, bean.getFec_desde(), bean.getFec_hasta()));  
                    bean.setEstado("CORRECTO");
                        link = "volver2";
                }
                else 
