            ...
            <html:hidden property="cd_numero" styleId="cd_numero" />
                ...
                <%if(!(bean == null))
                    ...
                    { 
                        ...
                        if(!(bean.getEstado().equals("REGISTRADO-MIRA") ||bean.getEstado().equals("REGISTRADO") ||bean.getEstado().equals("ASIGNADO")   || bean.getEstado().equals("VACIO")|| bean.getEstado().equals("NOTIFICADO")|| bean.getEstado().equals("ENVIO LEGAL")))
                        {   
                        
                        if(bean.getFecha_aceptacion_valid() == null || bean.getFecha_aceptacion_valid().equals(""))
                        {
...
<table><tr><td><html:text property="fecha_aceptacion" style="width:100px" maxlength="10" styleId="fecha_aceptacion"/>
                        ...
                        %><fieldset>
                         <table width="60%">
                            <tr>
                                <td><label >FECHA DE ACEPTACION REGISTRADA:</label>
                                </td>
                                <td><%=bean.getFecha_aceptacion_valid()%>
                                </td>
                            </tr>
                         </table>
                        </fieldset>
              ...
              <table width="60%">
                            ...
                            <td>
                         <%=Util.DevuelveRecAduanas(bean.getRec_aduana(),(String)request.getSession().getAttribute("user.gerencia"))%>
