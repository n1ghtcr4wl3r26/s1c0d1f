...
<table><tr><td><html:text property="fec_liq" style="width:100px" onblur="recupera_ufv()" maxlength="10" styleId="fec_liq"/>
                        ...
                        <tr>
                            ...
                            <td>  
                                <center>
                                    FINAL<br/>
                                    <html:text property="fobfinal" disabled="true"  style="width:100px;text-align:right" maxlength="18" styleId="fobfinal"/>  
                                </center>
                            </td>
                        </tr>
                        <tr><td colspan="3">&nbsp;</td></tr>
                            ...
                            <tr>
                                ...
                                <td  >
                                    <center>
                                 <html:text disabled="true" property="fec_liq" style="width:100px;text-align:right" onblur="recupera_ufv()" maxlength="10" styleId="fec_liq"/>
                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <html:text disabled="true" property="tributo_ga" onchange="MASK(this,this.value,'-$##,###,##0.00',1)" onblur="calcula_tributo()" style="width:100px;text-align:right" maxlength="18" styleId="tributo_ga"/>
                                    </center>
                                </td>
                                <td>
                                    <center>
                             ...
                             <tr>
                               <td>Tributo Omitido IVA:
                                ...
                                <td>
                                    <center>
                                        <html:text disabled="true" property="tributo_iva" onblur="calcula_tributo()" style="width:100px;text-align:right" maxlength="18" styleId="tributo_iva"/>
                                    </center>
                                </td>
                                <td>
                                    <center>
                             ...
                             <tr>
                               <td>Tributo Omitido ICE:
                                ...
                                <td>
                                    <center>
                                        <html:text disabled="true" property="tributo_ice" onblur="calcula_tributo()" style="width:100px;text-align:right" maxlength="18" styleId="tributo_ice"/>
                                    </center>
                                </td>
                                <td>
                                    <center>
                             ...
                             <tr>
                               <td>Tributo Omitido IEHD:
                                ...
                                <td>
                                    <center>
                                        <html:text disabled="true" property="tributo_iehd" onblur="calcula_tributo()" style="width:100px;text-align:right" maxlength="18" styleId="tributo_iehd"/>
                                    </center>
                                </td>
                                <td>
                                    <center>
                            ...
                            <tr>
                               <td >Sanci&oacute;n por Omisi&oacute;n de Pago:
                                ...
                                <td >
                                    <center>
                                        <html:text disabled="true" property="sancion" style="width:100px;text-align:right" maxlength="18" styleId="sancion"/>
                                    </center>
                                </td>
                                <td >
                                    <center>
                            ...
                            <tr>
                               <td >Multa por Contravenci&oacute;n Aduanera:
                                ...
                                <td >
                                    <center>
                                        <html:text disabled="true" property="multaca_ufv"  onblur="calcula_multaca()"  style="width:100px;text-align:right" maxlength="18" styleId="multaca_ufv"/>
                                    </center>
                                </td>
                            </tr>
                            <tr>
                               <td >Multa por Contrabando Contravencional:
                                ...
                                <td >
                                    <center>
                                        <html:text disabled="true" property="multacc" onblur="calcula_multacc()" style="width:100px;text-align:right" maxlength="18" styleId="multacc"/>
                                    </center>
                                </td>
                                <td >
                                    <center>
                            ...
                            <tr>
                               <td >Multa por Contrabando Delito:
                                ...
                                <td >
                                    <center>
                                        <html:text disabled="true" property="multacd" onblur="calcula_multacd()" style="width:100px;text-align:right" maxlength="18" styleId="multacd"/>
                                    </center>
                                </td>
                                <td >
                                    <center>
