...
%>
         ...
         <h2>RESULTADOS CONTROL DIFERIDO</h2>
            ...
            <html:hidden property="fecha_notificacion" styleId="fecha_notificacion" />
                ...
                <%if(!(bean == null))
                    ...
                    { 
                        ...
                        if(bean.getEstado().equals("NOTIFICADO"))
                        {                     
                        %> 
                             <tr><td>FOB Total (USD):</td><td>  <center>INICIAL<br/>
                             <html:text property="fobinicial" disabled="true" style="width:100px" maxlength="18" styleId="fobinicial"/> </center></td><td>  <center>FINAL<br/><html:text property="fobfinal" style="width:100px" maxlength="18" styleId="fobfinal"/>  </center></td></tr>
...
<table><tr><td><html:text property="fec_liq" style="width:100px" onblur="recupera_ufv()" maxlength="10" styleId="fec_liq"/>
                        ...
                        //if(bean.getEstado().equals("NOTIFICADO") || bean.getFec_liq() != null )
                        ...
                        <tr><td>FOB Total (USD):</td><td>  <center>INICIAL<br/>
                             <html:text property="fobinicial" disabled="true" style="width:100px" maxlength="18" styleId="fobinicial"/> </center></td><td>  <center>FINAL<br/><html:text property="fobfinal" disabled="true"  style="width:100px" maxlength="18" styleId="fobfinal"/>  </center></td></tr>
                        ...
                        <tr><td colspan="3">&nbsp;</td></tr>
                            ...
                            <tr>
                                ...
                                <td  >
                                    <center>
                                 <html:text disabled="true" property="fec_liq" style="width:100px" onblur="recupera_ufv()" maxlength="10" styleId="fec_liq"/>
                            ...
                            <tr>
                               <td>Tributo Omitido GA:
                                ...
                                <td>
                                    <center>
                                        <html:text disabled="true" property="tributo_ga" onblur="calcula_tributo()" style="width:100px" maxlength="18" styleId="tributo_ga"/>
                                    </center>
                                </td>
                                <td>
                                    <center>
                             ...
                             <tr>
                               <td>Tributo Omitido IVA:
                                ...
                                <td>
                                    <center>
                                        <html:text disabled="true" property="tributo_iva" onblur="calcula_tributo()" style="width:100px" maxlength="18" styleId="tributo_iva"/>
                                    </center>
                                </td>
                                <td>
                                    <center>
                             ...
                             <tr>
                               <td>Tributo Omitido ICE:
                                ...
                                <td>
                                    <center>
                                        <html:text disabled="true" property="tributo_ice" onblur="calcula_tributo()" style="width:100px" maxlength="18" styleId="tributo_ice"/>
                                    </center>
                                </td>
                                <td>
                                    <center>
                             ...
                             <tr>
                               <td>Tributo Omitido IEHD:
                                ...
                                <td>
                                    <center>
                                        <html:text disabled="true" property="tributo_iehd" onblur="calcula_tributo()" style="width:100px" maxlength="18" styleId="tributo_iehd"/>
                                    </center>
                                </td>
                                <td>
                                    <center>
                            ...
                            <tr>
                               <td >Multa por Contravencion Aduanera:
                                </td>
                                ...
                                <td >
                                    <center>
                                        <html:text disabled="true" property="multaca_ufv"  onblur="calcula_multaca()"  style="width:100px" maxlength="18" styleId="multaca_ufv"/>
                                    </center>
                                </td>
                            </tr>
                            <tr>
                               <td >Multa por Contravencion Contravencional:
                                </td>
                            
                                <td >
                                    <center>
                                        <html:text disabled="true" property="multacc" onblur="calcula_multacc()" style="width:100px" maxlength="18" styleId="multacc"/>
                                    </center>
                                </td>
                                <td >
                                    <center>
                            ...
                            <tr>
                               <td >Multa por Contrabando Delito:
                                ...
                                <td >
                                    <center>
                                        <html:text disabled="true" property="multacd" onblur="calcula_multacd()" style="width:100px" maxlength="18" styleId="multacd"/>
                                    </center>
                                </td>
                                <td >
                                    <center>
