...
<script type="text/javascript" charset="utf-8">
  function consultar(valor) {
      ...
      if (Mensaje == "") {
          $('#boton').val('consultar');
          document.FisRpendientesForm.submit();
      }
      else {
          alert(Mensaje);
          return false;
...
<html:form action="/FisRpendientes">
    <div id="formulario">
        ...
        %>         
        <h2>REPORTE DE CONTROLES DIFERIDOS PENDIENTES</h2>         
        <br/>
        <div id="form_registro">
            <fieldset>
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td height="35" width="25%" style="text-align:center">
                            <label>
            ...
            if(!(bean.getFec_desde()== null))
            {
                ...
                try {
                    ...
                    call = con.prepareCall("{ ? = call pkg_reporte.reportependientes (?,?,?,?) }");
                    ...
                    <table id='backgroun7'>
                        <tr>
                            <th>Fiscalizador</th>
                            <th style="width:200px;" width="100px">Controles Diferidos Asignados</th>
                            <th style="width:200px;" width="100px">Controles Diferidos Pendientes de Procesar</th>
                        </tr>
