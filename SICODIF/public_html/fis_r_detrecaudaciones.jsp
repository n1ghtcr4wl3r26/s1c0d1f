  ...
  function consultar(valor) {
    ...
    if (10 > mes) 
     ...
     if( ! fTrim( $('#gerencia').val() ) ){
      ...
      {
        $('#boton').val('consultar');
        document.FisRdetRecaudacionesForm.submit();
      }
      else
      {
        alert( Mensaje );
...
<html:form action="/FisRdetrecaudaciones" >
    <div id="formulario">
...
%>
         ...
         <h2>RESULTADOS DEUDA DETERMINADA</h2>
                ...
                <table width="100%" >
                    ...
                    <tr>    
                        ...
                        <td height="35">
                            ...
                            <table>
                                    <tr>
                                        <td><html:text property="fec_desde" style="width:100px" maxlength="10" styleId="fec_desde"/></td>
                                        <td><img src="img/calendar_1.png" id="imcal" style="cursor:pointer;" onclick="javascript:NewCssCal('fec_desde','ddMMyyyy')" /> </td>
                                    </tr>
                            </table>
