...
<script type="text/javascript" charset="utf-8">
  ...
  function consultar(valor) {
      ...
      {
        $('#boton').val('consultar');
        document.FisFiscalizadorEnmForm.submit();
      }
      else
      {
        alert( Mensaje );
...
<html:form action="/FisFiscalizadorEnm" >
    <div id="formulario">
        <%
        ...
        <h2>REASIGNACION FISCALIZADOR</h2>
            ...
            <input type="hidden" name="boton" id="boton" />
                ...
                <%if(!(bean == null))
                    ...
                    { 
                        ...
                        <tr><td colspan="2" height="40px">Fiscalizador:</td><td colspan="2" height="40px"><%=Util.DevuelveFiscalizadoresEnm(bean.getUsugerencia(), bean.getFiscalizador())%></td></tr>
                            <tr>
